...
#include <d3d11.h>
#include <tchar.h>
#include "Drawing.h" // Includes our custom UI logic
...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    // Set window size to 50,50 to make docked windows automatically appear outside even when the mainwindow is hidden
    ...
    while (!done)
    {
        ...
        //
        // Invoke our custom drawing logic
        //
        Drawing::Draw();
        ...
        //    bool isOpen = true;
        //    if (isOpen) {
        //        ImGui::SetNextWindowSize({ 350, 75 }, ImGuiCond_Once);
        //        ImGui::SetNextWindowBgAlpha(1.0f);
        //        ImGui::Begin("Hello, world!", &isOpen, WindowFlags);                          // Create a window called "Hello, world!" and append into it. 
